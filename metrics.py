...
class Metrics:
    def __init__(self):
        ...
        self.bridge_pool_skill = Gauge('cb_bridge_pool_skill', 'balanceOf', labels)
        ...
        self.pvp_tax_coffer = Gauge('cb_pvp_tax_coffer', 'gameCofferTaxDue', labels)
    ...
    def update_metrics(self, cb, network, block):
        ...
        self.bridge_pool_skill.labels(network).set(cb.w3.fromWei(cb.get_skill_balance(cb.bridge_address, block=block), 'ether'))
